...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let logURL = FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Library/Logs/Document Cleaner 1.2.log")
    ...
    private func configureMenuBar() {
        ...
        statusItem.button?.title = "✓ 1.2"
        statusItem.button?.toolTip = "Document Cleaner 1.2"
        let menu = NSMenu()
    ...
    private func showStartupError() {
        ...
        alert.informativeText = "Quit the app from the menu bar and open it again. If the problem continues, inspect Document Cleaner 1.2.log in Library/Logs."
        alert.runModal()
    }
}
